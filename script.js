...
function initCarousel(carouselData) {
    ...
    element.addEventListener('touchstart', stopAutoScroll);
    ...
    carouselData.startAutoScroll = startAutoScroll;
    carouselData.stopAutoScroll = stopAutoScroll;
...
function initContactHandlers() {
    ...
    // Обработчики для контактов в футере
